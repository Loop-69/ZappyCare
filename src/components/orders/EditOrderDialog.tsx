...
export const EditOrderDialog = ({ open, onOpenChange, orderId, onSuccess }: EditOrderDialogProps) => {
  ...
  const updateOrderMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["patient-orders", form.getValues("patient_id")] });
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      {sessions
                        .filter(session => session.patient_id === form.getValues("patient_id"))
                        .map((session) => (
